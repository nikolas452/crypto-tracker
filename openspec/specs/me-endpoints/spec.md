...
This capability exposes the authenticated user's own profile: reading it, updating the editable `displayName` field, and deleting the application data while leaving the underlying Firebase account intact.
