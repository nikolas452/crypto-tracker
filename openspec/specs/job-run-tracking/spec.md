...
This capability defines the persistent shape of job run records, which capture the outcome, timing, and statistics of each execution of the price-polling job for observability and status reporting.
