...
This capability exposes summary price statistics for a coin over a requested range — open, close, min, max, average, and percentage change — computed in a single aggregation pipeline.
