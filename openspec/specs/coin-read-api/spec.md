...
This capability exposes the public read endpoints for browsing and inspecting tracked coins — a paginated, sortable, searchable list and a single-coin detail view — built on validated query input and explicit output DTOs that never leak internal database fields.
