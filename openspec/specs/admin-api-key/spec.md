...
This capability provides provisional shared-secret authentication for the administrative API surface (`/api/v1/admin`), protecting job-run and other admin endpoints until proper role-based authorization is introduced in a later stage.
