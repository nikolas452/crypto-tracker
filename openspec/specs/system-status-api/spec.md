...
This capability exposes a public, unauthenticated status endpoint reporting the health of the price-polling job and the number of actively tracked coins, without leaking internal error details.
