...
This capability defines the persistent shape, uniqueness constraints, and lookup indexes for the `coins` collection, which stores each tracked cryptocurrency's identity and latest known market snapshot.
