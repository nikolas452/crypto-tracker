...
- **Referencing vs embedding:**
  - *Embeber* es guardar los datos relacionados dentro del mismo documento (por ejemplo, un array de monedas dentro del usuario).
  - *Referenciar* es guardar solo el ID y buscar el resto aparte.
  ...
  "data": [
    {
      ...
      "latest": { "priceUsd": 64210.12, "change24hPct": -1.23, "marketCapUsd": 1265000000000, "capturedAt": "..." }
    }
  ],
  "meta": { "count": 1, "max": 50 }
}
